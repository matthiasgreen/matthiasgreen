...
// Add an event listener to the document that listens for mouse clicks
...
// Add an event listener to the document that listens for mouse clicks and touch events
document.addEventListener("click", handleTouchEvent);
document.addEventListener("touchstart", handleTouchEvent);

// Handle the touch event and create a new Food object
